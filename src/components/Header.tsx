        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="hidden md:block">
              <span>swiftassistkerugoya@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <div className="text-2xl font-bold text-blue-600">Swift Assist</div>
              <div className="ml-2 text-sm text-gray-600 hidden sm:block">Kerugoya</div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="tel:0111679286" className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                Call Now
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="tel:0111679286" className="block mx-3 mt-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-center">
                  Call Now
                </a>
              </div>
            </div>
